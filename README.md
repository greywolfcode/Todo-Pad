...
<img src=images/assembled_model.png alt="PCB" width="300"/>

## CAD
The lid is designed to attach with a friction fit to allow it to be removed, and is angled at 5 degrees. case.step has just the case models, whereas full_model.step is the assembled model with PCB
<img src=images/exploded_view.png alt="PCB" width="300"/>

## PCB
The PCB was designed in KiCad
This is the schematic:
<img src=images/shematic.png alt="Schematic" width="300"/>
And here is the PCB:
...
<img src=images/editor.png alt="PCB" width="300"/>
